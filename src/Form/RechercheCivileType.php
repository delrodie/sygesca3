...
class RechercheCivileType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('dateNaissance', TextType::class,['attr'=>['class'=>"form-control datepicker", 'placeholder'=>"Date de naisance",'autocomplete'=>"off", 'readonly'=>true]])
